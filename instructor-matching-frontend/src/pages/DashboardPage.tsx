...
import { Plus, X, FileText, Users, CheckCircle2 } from 'lucide-react';
      ...
      <div className="flex-1 grid grid-cols-3 gap-4 min-h-0">
        ...
        <div className="flex flex-col min-h-0">
          <div className="flex items-center gap-2 mb-3 px-1">
            ...
            <span className="text-[10px] bg-amber-50 text-amber-600 px-1.5 py-0.5 rounded-full font-semibold">{matchingItems.length}</span>
          </div>
          <div className="flex-1 bg-slate-50 rounded-xl p-2.5 overflow-y-auto space-y-2">
        ...
        <div className="flex flex-col min-h-0">
          <div className="flex items-center gap-2 mb-3 px-1">
            ...
            <span className="text-[10px] bg-green-50 text-green-600 px-1.5 py-0.5 rounded-full font-semibold">{doneItems.length}</span>
          </div>
          <div className="flex-1 bg-slate-50 rounded-xl p-2.5 overflow-y-auto space-y-2">
            {doneItems.length > 0 ? (
